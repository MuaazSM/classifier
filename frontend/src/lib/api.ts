// frontend/src/lib/api.ts - Environment-configurable API
...
class TaqneeqAPI {
  ...
  constructor() {
    // Environment-configurable API URL with fallbacks
  ...
  private getBaseURL(): string {
    ...
    // 1. NEXT_PUBLIC_API_URL (full URL)
    // 2. NEXT_PUBLIC_BACKEND_URL + /api/v1 (base URL + path)
    // 3. NEXT_PUBLIC_BACKEND_HOST + NEXT_PUBLIC_BACKEND_PORT (host + port)
    // 4. Default fallback
